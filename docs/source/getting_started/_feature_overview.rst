...
.. grid:: 1
   ...
   .. grid-item-card:: Pie Menu Editor
      ...
      .. image:: ../_static/images/overview/overview_vid_pie.png
         :alt: Pie Menu Demo
         :class: sd-w-100 sd-rounded-2
         :target: https://www.youtube.com/watch?v=COW109EjBsU
   ...
   .. grid-item-card:: Regular Menu Editor
      ...
      .. image:: ../_static/images/overview/overview_vid_menu.png
         :alt: Regular Menu Demo
         :class: sd-w-100 sd-rounded-2
         :target: https://www.youtube.com/watch?v=bvDADkqMLEw
   ...
   .. grid-item-card:: Pop-up Dialog Editor
      ...
      .. image:: ../_static/images/overview/overview_vid_popup.png
         :alt: Popup Dialog Demo
         :class: sd-w-100 sd-rounded-2
         :target: https://www.youtube.com/watch?v=JdbmDSV9wIU
   ...
   .. grid-item-card:: Sticky Key Editor
      ...
      .. image:: ../_static/images/overview/overview_vid_sticky.png
         :alt: Sticky Key Demo
         :class: sd-w-100 sd-rounded-2
         :target: https://www.youtube.com/watch?v=pcFOPWnHC7U
   ...
   .. grid-item-card:: Stack Key Editor
      ...
      .. image:: ../_static/images/overview/overview_vid_stack.png
         :alt: Stack Key Demo
         :class: sd-w-100 sd-rounded-2
         :target: https://www.youtube.com/watch?v=4wZKiyKE_P4
   ...
   .. grid-item-card:: Macro Operator Editor
      ...
      .. image:: ../_static/images/overview/overview_vid_macro.png
         :alt: Macro Operator Demo
         :class: sd-w-100 sd-rounded-2
         :target: https://www.youtube.com/watch?v=x4HhN4aHCxg
   ...
   .. grid-item-card:: Modal Operator Editor
      ...
      .. image:: ../_static/images/overview/overview_vid_modal.png
         :alt: Modal Operator Demo
         :class: sd-w-100 sd-rounded-2
         :target: https://youtu.be/aDEX5bix384
   ...
   .. grid-item-card:: Side Panel Editor
      ...
      .. image:: ../_static/images/overview/overview_vid_pg.png
         :alt: Side Panel Editor Demo
         :class: sd-w-100 sd-rounded-2
         :target: https://www.youtube.com/watch?v=BGs0de6ZYdw
   ...
   .. grid-item-card:: Hiding Unused Panels
      ...
      .. image:: ../_static/images/overview/overview_vid_hpg.png
         :alt: Hiding Unused Panels Demo
         :class: sd-w-100 sd-rounded-2
         :target: https://www.youtube.com/watch?v=z19c6b7XOWo
   ...
   .. grid-item-card:: Property Editor
      ...
      .. image:: ../_static/images/overview/overview_vid_property.png
         :alt: Property Editor Demo
         :class: sd-w-100 sd-rounded-2
         :target: https://youtu.be/xQ-ETd8xacA
